    ...
    <Layout :enable-watching="false" :disable-sidemenu="true">
        <template #page-header>
            <div v-if="fm && (fm.hero || fm.events)">
                <div v-if="fm.hero" class="home-hero" :style="fm.hero.background
                    ? {
                   ...
                   url(${fm.hero.background})`,
                    ...
                    <a v-for="(action, i) in fm.hero.actions" :key="i" class="hero-actions" :href="action.link">
                ...
                <SteamRecentMaps v-if="fm.recentSteamMaps && fm.recentSteamMaps.enabled" :title="fm.recentSteamMaps.title"
                    :amount="fm.recentSteamMaps.amount" :type="fm.recentSteamMaps.type" />
            </div>
        </template>
    </Layout>
</template>
