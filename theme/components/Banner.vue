<template>
    <div>
        <v-banner :style="{ '--color': bgColorValue, '--color-hover': getString(backgroundHoverColor, bgColorValue) }"
            class="d-flex align-center justify-center flex-wrap flex-row my-4" rounded shaped single-line v-if="enabled">
            <div class="d-flex align-center flex-row"
                :style="{ justifyContent: textPlacement === 'right' ? 'space-between' : undefined }">
